...
import { faEye as watchedEye} from "@fortawesome/free-solid-svg-icons";
import { faEyeSlash as unwatchedEye} from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="movie-card" onClick={handleClick}>
            ...
            <div className="interactive-buttons">
                ...
                <button onClick={handleWatchedBttn}>{isWatched? <FontAwesomeIcon icon={watchedEye}/> : <FontAwesomeIcon icon={unwatchedEye}/>}</button>
            </div>
        </div>
    )
}
